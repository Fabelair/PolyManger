...
import {connection,gestionDeConnection,getConnectionId,getConnectionStatus,signUp} from "../functions/gestionDeConnection"
function Connect(self){
    const [isloading,setIsloading] = useState(false);
    const [connected,setConnection] = useState(getConnectionStatus());
        ...
        return(<div class="h-screen grid">
            <div class="place-self-center h-[32rem] w-[32rem] grid">
                <div class="ring ring-black dark:ring-white w-full h-flex  rounded-xl grid">
                    ...
                    <div role="status" class="flex items-center  place-self-center h-full mb-20 grid grid-rows-2">
                        <span class="place-self-center inline-flex items-center justify-center w-16 h-16 me-2 ring-4 ring-green-300 text-xl font-semibold rounded-full text-green-300">
                            <svg class="w-8 h-8" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5"/>
                            </svg>
                            <span class="sr-only">Icon description</span>
                        </span>
                        <button class=" h-14 w-40 rounded-xl bg-red-400 text-xl font-bold" onClick={()=>{deconnect()}}>
                            Déconnexion
                        </button>
                    </div>
                </div>
    ...
    return(<div class="h-screen grid">
        <div class="place-self-center h-[32rem] w-[32rem] grid">
            <div class="ring ring-black dark:ring-white w-full h-flex  rounded-xl grid">
                ...
                {isloading?
                    <div role="status" class="flex items-center  place-self-center h-full mb-40">
